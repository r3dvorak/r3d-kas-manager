...
<form class="uk-grid-small uk-margin" uk-grid method="GET" action="{{ route('admin.mailforwards.preview') }}">
    ...
    <div class="uk-width-auto@m">
        <a class="uk-button uk-button-default" href="{{ route('admin.mailforwards.index', ['kas_login'=>$kasLogin]) }}">Zurueck</a>
    </div>
    <div class="uk-width-auto@m">
