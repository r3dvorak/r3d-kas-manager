...
@section('content')
<h1 class="uk-heading-line"><span>Domains: Pruefung (KAS vs DB)</span></h1>

<p class="uk-text-small uk-text-muted">
    Diese Ansicht zeigt die Unterschiede zwischen der KAS-API (remote) und dem aktuellen DB-Snapshot (lokal).
</p>
...
<div class="uk-margin-top">
    <a class="uk-button uk-button-default" href="{{ route_w('client.domains.index') }}">Zurueck</a>
</div>
@endsection
