...
<div class="uk-flex uk-flex-between uk-flex-middle uk-margin-small">
    ...
    <div class="uk-flex uk-flex-middle uk-grid-small" uk-grid>
        <div>
            <a class="uk-button uk-button-primary" href="{{ route_w('client.coming-soon', ['resource' => 'subdomains']) }}">{{ __('ui.common.new') }}</a>
        </div>
        <div>
            <a class="uk-button uk-button-default" href="{{ route_w('client.subdomains.preview') }}"><span uk-icon="refresh" class="uk-margin-small-right"></span>{{ __('ui.common.check_changes') }}</a>
        </div>
        <div>
